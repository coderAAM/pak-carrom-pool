...
import { Coin, GameState, AimState } from '@/types/game';
import {
  applyFriction,
  updatePosition,
  checkWallCollision,
...
export const useCarromGame = () => {
    ...
    setGameState((prev) => {
      ...
      if (!isMoving(allCoins)) {
        ...
        return {
          ...
          winner,
          message: winner ? `Player ${winner} wins!` : message,
        };
      }
  ...
  }, [gameState.gamePhase, gameState.striker]);
